...
The current development version is `0.2.7`. It adds rotated u/v spatial scans
...
STRKR and SRKR 2D place the angle input beside the selected u/v axis,
including when that axis is Slow Axis.
